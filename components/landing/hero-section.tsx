        ...
        <div className="flex flex-col gap-8 md:gap-12">
          <div className="space-y-4 md:space-y-6 w-full text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-4 justify-center items-center px-2">
              <button className="w-full sm:w-auto px-6 sm:px-8 py-2.5 sm:py-3 bg-helix-primary text-white font-medium rounded-full hover:bg-helix-secondary transition flex items-center justify-center gap-2 shadow-lg text-sm sm:text-base">
